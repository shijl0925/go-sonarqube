...
type InstallRequest struct {
	Key string `form:"key,omitempty"` // The key identifying the plugin to install
}
...
type InstalledRequest struct {
	F string `form:"f,omitempty"` // Comma-separated list of the additional fields to be returned in response. No additional field is returned by default. Possible values are:<ul><li>category - category as defined in the Update Center. A connection to the Update Center is needed</li></ul>
}
...
type UninstallRequest struct {
	Key string `form:"key,omitempty"` // The key identifying the plugin to uninstall
}
...
type UpdateRequest struct {
	Key string `form:"key,omitempty"` // The key identifying the plugin to update
}
