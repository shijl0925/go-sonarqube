...
type AddRequest struct {
	Component string `form:"component"` // Component key. Only components with qualifiers TRK, VW, SVW, APP are supported
}
...
type RemoveRequest struct {
	Component string `form:"component"` // Component key
}
