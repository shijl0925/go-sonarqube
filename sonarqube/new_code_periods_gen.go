...
// List - Lists the <a href="https://docs.sonarsource.com/sonarqube-server/2026.2/project-administration/configuring-new-code-calculation#setting-specific-new-code-definition-for-project" target="_blank" rel="noopener noreferrer">new code definition</a> for all branches in a project.
...
// Set - Updates the <a href="https://docs.sonarsource.com/sonarqube-server/2026.2/project-administration/configuring-new-code-calculation#setting-specific-new-code-definition-for-project" target="_blank" rel="noopener noreferrer">new code definition</a> on different levels:
//
...
// Show - Shows the <a href="https://docs.sonarsource.com/sonarqube-server/2026.2/project-administration/configuring-new-code-calculation#setting-specific-new-code-definition-for-project" target="_blank" rel="noopener noreferrer">new code definition</a>.
