...
// ListRequest Lists the <a href="https://sonar-documentations-preview.netlify.app/sonarqube/10.8/project-administration/clean-as-you-code-settings/defining-new-code/" target="_blank" rel="noopener noreferrer">new code definition</a> for all branches in a project.<br>Requires the permission to browse the project
