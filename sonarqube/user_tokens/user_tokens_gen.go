...
type GenerateRequest struct {
	ExpirationDate string `form:"expirationDate,omitempty"` // The expiration date of the token being generated, in ISO 8601 format (YYYY-MM-DD). If not set, default to no expiration.
	...
	ProjectKey     string `form:"projectKey,omitempty"`     // The key of the only project that can be analyzed by the PROJECT_ANALYSIS_TOKEN being generated.
	Type           string `form:"type,omitempty"`           // Token Type. If this parameters is set to PROJECT_ANALYSIS_TOKEN, it is necessary to provide the projectKey parameter too.
}
