...
type GenerateRequest struct {
	ExpirationDate string `form:"expirationDate,omitempty"` // Since 9.6;The expiration date of the token being generated, in ISO 8601 format (YYYY-MM-DD). If not set, default to no expiration.
	Login          string `form:"login,omitempty"`          // User login. If not set, the token is generated for the authenticated user.
	Name           string `form:"name"`                     // Token name
	ProjectKey     string `form:"projectKey,omitempty"`     // Since 9.5;The key of the only project that can be analyzed by the PROJECT_ANALYSIS_TOKEN being generated.
	Type           string `form:"type,omitempty"`           // Since 9.5;Token Type. If this parameters is set to PROJECT_ANALYSIS_TOKEN, it is necessary to provide the projectKey parameter too.
}
