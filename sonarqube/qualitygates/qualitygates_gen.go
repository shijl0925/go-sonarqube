...
type CreateConditionRequest struct {
	...
	Metric   string `form:"metric"`       // Condition metric.<br/> Only metric of the following types are allowed:<ul><li>INT</li><li>MILLISEC</li><li>RATING</li><li>WORK_DUR</li><li>FLOAT</li><li>PERCENT</li><li>LEVEL</li></ul>Following metrics are forbidden:<ul><li>software_quality_maintainability_debt_ratio</li><li>software_quality_reliability_rating</li><li>new_software_quality_security_remediation_effort</li><li>software_quality_maintainability_remediation_effort</li><li>new_software_quality_maintainability_remediation_effort</li><li>effort_to_reach_software_quality_maintainability_rating_a</li><li>software_quality_security_remediation_effort</li><li>new_software_quality_reliability_rating</li><li>new_software_quality_security_rating</li><li>software_quality_security_rating</li><li>new_security_hotspots</li><li>new_software_quality_maintainability_rating</li><li>software_quality_maintainability_rating</li><li>alert_status</li><li>security_hotspots</li><li>software_quality_reliability_remediation_effort</li><li>new_software_quality_maintainability_debt_ratio</li><li>new_software_quality_reliability_remediation_effort</li></ul>
