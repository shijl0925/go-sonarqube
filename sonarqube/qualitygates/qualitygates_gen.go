...
type AddGroupRequest struct {
	GateName  string `form:"gateName"`  // Quality Gate name
...
type CopyRequest struct {
	Name       string `form:"name"`       // The name of the quality gate to create
	SourceName string `form:"sourceName"` // Since 8.4;The name of the quality gate to copy
}
...
type CreateConditionRequest struct {
	...
	Metric   string `form:"metric"`       // Condition metric.<br/> Only metric of the following types are allowed:<ul><li>INT</li><li>MILLISEC</li><li>RATING</li><li>WORK_DUR</li><li>FLOAT</li><li>PERCENT</li><li>LEVEL</li></ul>Following metrics are forbidden:<ul><li>new_software_quality_reliability_remediation_effort</li><li>software_quality_maintainability_debt_ratio</li><li>software_quality_security_remediation_effort</li><li>software_quality_security_review_rating</li><li>new_software_quality_maintainability_debt_ratio</li><li>effort_to_reach_software_quality_maintainability_rating_a</li><li>new_software_quality_security_rating</li><li>new_software_quality_security_review_rating</li><li>software_quality_maintainability_remediation_effort</li><li>new_security_hotspots</li><li>alert_status</li><li>software_quality_maintainability_rating</li><li>software_quality_reliability_rating</li><li>new_software_quality_reliability_rating</li><li>new_software_quality_security_remediation_effort</li><li>software_quality_security_rating</li><li>new_software_quality_maintainability_rating</li><li>new_software_quality_maintainability_remediation_effort</li><li>software_quality_reliability_remediation_effort</li><li>security_hotspots</li></ul>
...
type DeleteConditionRequest struct {
	Id string `form:"id"` // Condition UUID
}
...
type DeselectRequest struct {
	ProjectKey string `form:"projectKey"` // Since 6.1;Project key
}
...
type DestroyRequest struct {
	Name string `form:"name"` // Since 8.4;Name of the quality gate to delete
}
...
type RenameRequest struct {
	CurrentName string `form:"currentName"` // Since 8.4;Current name of the quality gate
	Name        string `form:"name"`        // New name of the quality gate
}
...
type SelectRequest struct {
	GateName   string `form:"gateName"`   // Since 8.4;Name of the quality gate
	ProjectKey string `form:"projectKey"` // Since 6.1;Project key
}
...
type SetAsDefaultRequest struct {
	Name string `form:"name"` // Since 8.4;Name of the quality gate to set as default
}
