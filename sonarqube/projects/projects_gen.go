...
type BulkDeleteRequest struct {
	AnalyzedBefore    string `form:"analyzedBefore,omitempty"`    // Since 6.6;Filter the projects for which last analysis of any branch is older than the given date (exclusive).<br> Either a date (server timezone) or datetime can be provided.
	OnProvisionedOnly string `form:"onProvisionedOnly,omitempty"` // Since 6.6;Filter the projects that are provisioned
...
type CreateRequest struct {
	MainBranch             string `form:"mainBranch,omitempty"`             // Since 9.8;Key of the main branch of the project. If not provided, the default main branch key will be used.
	Name                   string `form:"name"`                             // Name of the project. If name is longer than 500, it is abbreviated.
	...
	Visibility             string `form:"visibility,omitempty"`             // Since 6.4;Whether the created project should be visible to everyone, or only specific user/groups.<br/>If no visibility is specified, the default project visibility will be used.
}
...
type UpdateVisibilityRequest struct {
	Project    string `form:"project"`    // Project, application or portfolio key
	Visibility string `form:"visibility"` // New visibility
}
