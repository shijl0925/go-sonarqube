...
type ComponentTreeRequest struct {
	...
	MetricKeys       string `url:"metricKeys"`                 // Comma-separated list of metric keys. Types DISTRIB are not allowed. For type DATA only reliability_issues, maintainability_issues, security_issues, new_reliability_issues, new_security_issues, new_maintainability_issues metrics are supported
