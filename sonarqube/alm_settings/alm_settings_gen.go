...
type CreateAzureRequest struct {
	Key                 string `form:"key,omitempty"`                 // Unique key of the Azure Devops instance setting
	PersonalAccessToken string `form:"personalAccessToken,omitempty"` // Azure Devops personal access token
	Url                 string `form:"url,omitempty"`                 // Azure API URL
}
...
type CreateBitbucketRequest struct {
	Key                 string `form:"key,omitempty"`                 // Unique key of the Bitbucket instance setting
	PersonalAccessToken string `form:"personalAccessToken,omitempty"` // Bitbucket personal access token
	Url                 string `form:"url,omitempty"`                 // BitBucket server API URL
}
...
type CreateBitbucketcloudRequest struct {
	ClientId     string `form:"clientId,omitempty"`     // Bitbucket Cloud Client ID
	ClientSecret string `form:"clientSecret,omitempty"` // Bitbucket Cloud Client Secret
	Key          string `form:"key,omitempty"`          // Unique key of the Bitbucket Cloud setting
	Workspace    string `form:"workspace,omitempty"`    // Bitbucket Cloud workspace ID
}
...
type CreateGithubRequest struct {
	AppId         string `form:"appId,omitempty"`         // GitHub App ID
	ClientId      string `form:"clientId,omitempty"`      // GitHub App Client ID
	ClientSecret  string `form:"clientSecret,omitempty"`  // GitHub App Client Secret
	Key           string `form:"key,omitempty"`           // Unique key of the GitHub instance setting
	PrivateKey    string `form:"privateKey,omitempty"`    // GitHub App private key
	Url           string `form:"url,omitempty"`           // GitHub API URL
...
type SetAzureBindingRequest struct {
	AlmSetting     string `form:"almSetting,omitempty"`     // Azure DevOps setting key
	Monorepo       string `form:"monorepo,omitempty"`       // Is this project part of a monorepo
	Project        string `form:"project,omitempty"`        // SonarQube project key
...
type SetBitbucketBindingRequest struct {
	AlmSetting string `form:"almSetting,omitempty"` // Bitbucket Server setting key
	Monorepo   string `form:"monorepo,omitempty"`   // Is this project part of a monorepo
	Project    string `form:"project,omitempty"`    // Project key
	Repository string `form:"repository,omitempty"` // Bitbucket Server repository key
	Slug       string `form:"slug,omitempty"`       // Bitbucket repository slug
}
...
type SetBitbucketcloudBindingRequest struct {
	AlmSetting string `form:"almSetting,omitempty"` // Bitbucket Cloud setting key
	Monorepo   string `form:"monorepo,omitempty"`   // Is this project part of a monorepo
	Project    string `form:"project,omitempty"`    // Project key
	Repository string `form:"repository,omitempty"` // Bitbucket Cloud repository key
}
...
type SetGithubBindingRequest struct {
	AlmSetting            string `form:"almSetting,omitempty"`            // GitHub setting key
	Monorepo              string `form:"monorepo,omitempty"`              // Is this project part of a monorepo
	Project               string `form:"project,omitempty"`               // Project key
	Repository            string `form:"repository,omitempty"`            // GitHub Repository
...
type SetGitlabBindingRequest struct {
	AlmSetting string `form:"almSetting,omitempty"` // GitLab setting key
	Monorepo   string `form:"monorepo,omitempty"`   // Is this project part of a monorepo
	Project    string `form:"project,omitempty"`    // Project key
	Repository string `form:"repository,omitempty"` // GitLab project ID
}
...
type UpdateAzureRequest struct {
	Key                 string `form:"key,omitempty"`                 // Unique key of the Azure instance setting
...
type UpdateBitbucketRequest struct {
	...
	PersonalAccessToken string `form:"personalAccessToken,omitempty"` // Bitbucket personal access token
	Url                 string `form:"url,omitempty"`                 // Bitbucket API URL
}
...
type UpdateGithubRequest struct {
	AppId         string `form:"appId,omitempty"`         // GitHub API ID
	ClientId      string `form:"clientId,omitempty"`      // GitHub App Client ID
	ClientSecret  string `form:"clientSecret,omitempty"`  // GitHub App Client Secret
	Key           string `form:"key,omitempty"`           // Unique key of the GitHub instance setting
...
type ValidateRequest struct {
	Key string `form:"key,omitempty"` // Unique key of the DevOps Platform settings
}
